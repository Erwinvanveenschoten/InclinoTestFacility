...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="TIMER" URI="http://resources/4.1.10/app/TIMER/0" description="Provides an accurate timer by using hardware CCU timer.&#xA; This can be used as a trigger input to other peripherals or to create an event" mode="NOTSHARABLE" version="4.1.10" minDaveVersion="4.3.2" instanceLabel="ISB_TIMER" appLabel="" containingProxySignal="true">
  ...
  <hwResources name="CC4 Timer" URI="http://resources/4.1.10/app/TIMER/0/hwres_ccu4_cc4" resourceGroupUri="resources/48.0.1/peripheral/ccu4/3/cc4/3" mResGrpUri="peripheral/ccu4/*/cc4/*">
  ...
  <connections URI="http://resources/4.1.10/app/TIMER/0/http://resources/4.1.10/app/TIMER/0/vs_global_ccu8_enable/http://resources/4.1.10/app/TIMER/0/vs_timer_ccu8_global_enable" systemDefined="true" sourceSignal="ccu8_global" targetSignal="global_enable" required="false" targetVirtualSignal="//@virtualSignals.3" proxySrcVirtualSignalUri="http://resources/4.1.12/app/GLOBAL_CCU8/0/vs_global_ccu8_globalsignal" containingProxySignal="true"/>
