...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="TIMER" URI="http://resources/4.1.10/app/TIMER/0" description="Provides an accurate timer by using hardware CCU timer.&#xA; This can be used as a trigger input to other peripherals or to create an event" mode="NOTSHARABLE" version="4.1.10" minDaveVersion="4.3.2" instanceLabel="TICK_TIMER" appLabel="" containingProxySignal="true">
  ...
  <connections URI="http://resources/4.1.10/app/TIMER/0/http://resources/4.1.10/app/TIMER/0/vs_timer_ccu4_period_match_interrupt/http://resources/4.0.8/app/INTERRUPT/3/vs_nvic_signal_in" sourceSignal="event_time_interval" targetSignal="sr_irq" srcVirtualSignal="//@virtualSignals.0">
